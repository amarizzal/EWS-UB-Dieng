                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{ route('user.update', $user->id) }}" class="text-warning font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Ubah
                        </a>

                        <!-- Link-style delete using a tag -->
                        <a href="#" class="text-danger ms-3 font-weight-bold text-xs"
                            onclick="event.preventDefault(); if (confirm('Are you sure you want to delete this user? All data related to this user ({{ $user->record->count() }} ews record) will be deleted.')) { document.getElementById('delete-form{{$user->id}}').submit(); }">
                            Hapus
                        </a>
