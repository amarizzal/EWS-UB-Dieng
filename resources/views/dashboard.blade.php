              ...
              <form method="POST" action="{{ route('dashboard.store') }}">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="name" class="form-control" value="" id="exampleFormControlInput1" placeholder="nama pasien">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="exampleFormControlInput1">No. Rekam Medis</label>
                    <input type="number" name="medic_number" class="form-control" value="" id="exampleFormControlInput1" placeholder="no. rekam medis">
                  </div>

                  <div class="form-group col-md-4 border-end">
                    <label for="score_1">Pernapasan</label>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_1" id="score_1_1" value="2">
                      <label class="custom-control-label" for="score_1_1">< 8</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_1" id="score_1_2" value="1">
                      <label class="custom-control-label" for="score_1_2">8</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_1" id="score_1_3" value="0">
                  ...
                  <div class="form-group col-md-4 border-end">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_2" id="score_2_1" value="2">
                      <label class="custom-control-label" for="score_2_1">< 40</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_2" id="score_2_2" value="1">
                      <label class="custom-control-label" for="score_2_2">40 - 50</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_2" id="score_2_3" value="0">
                  ...
                  <div class="form-group col-md-4 border-end">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_3" id="score_3_1" value="3">
                      <label class="custom-control-label" for="score_3_1"><= 70</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_3" id="score_3_2" value="2">
                      <label class="custom-control-label" for="score_3_2">71 - 80</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_3" id="score_3_3" value="1">
                      <label class="custom-control-label" for="score_3_3">81 - 100</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_3" id="score_3_4" value="0">
                      <label class="custom-control-label" for="score_3_4">101 - 159</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_3" id="score_3_5" value="1">
                  ...
                  <div class="form-group col-md-4 border-end">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_4" id="score_4_1" value="3">
                      <label class="custom-control-label" for="score_4_1">Tidak ada respon (coma)</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_4" id="score_4_2" value="2">
                      <label class="custom-control-label" for="score_4_2">Respon terhadap rangsang nyeri (Stupor)</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_4" id="score_4_3" value="1">
                      <label class="custom-control-label" for="score_4_3">Respon terhadap suara (Somnolen)</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="score_4" id="score_4_4" value="0">
                  ...
                  <div class="form-group col-md-4 border-end">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_5" id="score_5_2" value="2">
                      <label class="custom-control-label" for="score_5_2">< 35 C</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_5" id="score_5_3" value="1">
                      <label class="custom-control-label" for="score_5_3">35 C - 36 C</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="score_5" id="score_5_4" value="0">
